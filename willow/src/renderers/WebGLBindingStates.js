...
function WebGLBindingStates(gl, attributes) {
  ...
  function setup(object, material, program, geometry, index) {
    ...
    const state = getBindingState(geometry, program, material); // create vao
    ...
    if (index !== null) {
      attributes.update(index, gl.ELEMENT_ARRAY_BUFFER); // update global index attribute
    }
  ...
  // core line: gl.enableVertexAttribArray(attribute);
